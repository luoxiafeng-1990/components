...
public:
    ...
    /**
     * @brief 获取本 Line 在 ComponentTopology 中的拓扑 ID
     * @return 拓扑 Line ID，0 表示未注册
     */
    uint64_t getLineRegistryId() const { return line_registry_id_; }
