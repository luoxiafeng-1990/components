...
int main(int argc, char* argv[]) {
    ...
    if (!hw_writer.openRaw("/tmp/hw_decoder_output.yuv", hw_format, hw_width, hw_height)) {
    ...
    if (!sw_writer.openRaw("/tmp/sw_decoder_output.yuv", sw_format, sw_width, sw_height)) {
